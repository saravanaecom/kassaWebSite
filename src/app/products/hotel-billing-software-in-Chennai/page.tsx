...
const QUICK_FEATURES = [
  { label: "Hotel & Restaurant Billing", color: "#2563EB" },
  { label: "GST Invoice Generation",     color: "#7C3AED" },
  { label: "Mobile Order Taking",        color: "#059669" },
  { label: "Order Tracking",             color: "#D97706" },
  { label: "Delivery Management",        color: "#DC2626" },
  { label: "CRM & Loyalty",              color: "#16A34A" },
  { label: "Hotel Analytics",            color: "#0284C7" },
  { label: "Customized Invoices",        color: "#EA4335" },
];
...
>
  <strong style={{ color: "#0F172A", fontWeight: 700 }}>
    Kassapos Hotel Billing Software
  </strong>{" "}
  helps hotels, resorts, lodges, and clubs streamline room bookings,
  billing, check-in/check-out, restaurant billing, mobile ordering,
  order tracking, delivery management, GST invoicing, and business
  reporting through one intelligent platform.
</p>
...
>
  Simplify room reservations, guest management, billing,
  check-in/check-out, restaurant and room service, mobile ordering,
  inventory, housekeeping, analytics, and GST reporting with one
  powerful solution built for modern hotels and hospitality businesses.
</p>
</motion.div>

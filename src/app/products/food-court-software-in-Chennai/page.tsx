        ...
        <div className="container-xl" style={{ paddingLeft: 24, paddingRight: 24, position: "relative", zIndex: 1 }}>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 items-center" style={{ paddingBottom: 56 }}>
            ...
            >
              ...
              >
                The Smart Billing Software for Modern{" "}
                <span style={{ color: "#2563EB" }}>Food Courts</span> Smarter Operations
                
              </h1>

              <p style={{ color: "#64748B", marginBottom: 28, fontSize: "0.95rem", lineHeight: 1.75, maxWidth: 520 ,marginLeft: "0%"}}>
              Transform your food court business with <strong style={{ color: "#0F172A", fontWeight: 700 }}>
              KASSAPOS, a complete POS and billing solution designed
  </strong> for modern food courts, quick-service restaurants, and multi-counter operations.
              </p>
            ...
            >
              {!videoPlaying ? (
                <div className="relative cursor-pointer" style={{ aspectRatio: "16/9", background: "#000" }} onClick={() => setVideoPlaying(true)}>
                  ...
                  <img   src="/images/RestaurantMobileBillingSoftware.webp"alt="Kassapos Supermarket POS Demo" style={{ width: "120%", height: "175%", objectFit: "cover", opacity: 0.82 }} />
...
Revolutionizing{" "}
  ...
  </span>  with Unified Commerce and Intelligent
</h2>
...
>
Streamline multi-counter billing, kitchen workflows, inventory control, customer engagement, GST compliance, and real-time analytics with KASSAPOS Food Court Billing Software.
</p>

...
const QUICK_FEATURES = [
  { label: "Online & Offline Billing",   color: "#2563EB" },
  { label: "GST Invoice Generation",     color: "#7C3AED" },
  { label: "Barcode Billing",            color: "#059669" },
  { label: "Multiple Payment Options",   color: "#D97706" },
  { label: "Inventory Management",       color: "#DC2626" },
  { label: "Email Invoice",              color: "#16A34A" },
  { label: "Cloud & Mobile Reports",     color: "#0284C7" },
...
const TABS = [
  ...
  },
  {
    ...
    items: [
      ...
      "Customer GST Bill History",
      "PDF Invoice Export",
      "User-wise Sales Reports",
      "Cash Book & Day Book",
      "Real-Time Business Dashboard",
      "Google Drive Auto Backup",
      "Mobile Business Reports",
...
>
  Smart <span style={{ color: "#2563EB" }}>Online Billing Software</span> for Every Business
</h1>
...
>
  <strong style={{ color: "#0F172A", fontWeight: 700 }}>
    Kassapos Online Billing Software
  </strong>{" "}
  helps businesses streamline billing, inventory management, GST invoicing,
  warehouse management, customer records, and multiple payment methods through
  a secure cloud-based platform. Designed for retail stores, supermarkets,
  mobile shops, restaurants, pharmacies, textile stores, and many other
  industries, it enables fast billing and real-time business management from
  anywhere.
</p>
            ...
            >
              {!videoPlaying ? (
                <div className="relative cursor-pointer" style={{ aspectRatio: "16/9", background: "#000" }} onClick={() => setVideoPlaying(true)}>
                  ...
                  <img   src="/images/OnlineBIllingSoftware.webp"alt="Kassapos Supermarket POS Demo" style={{ width: "120%", height: "175%", objectFit: "cover", opacity: 0.82 }} />
...
<SectionLabel className="mx-auto mb-4">
  Online Business Management Suite
</SectionLabel>
...
>
  Simplify online billing, GST invoicing, inventory management,
  warehouse operations, customer management, multiple payment methods,
  purchase tracking, sales analytics, and business reporting with one
  powerful cloud-based solution built for businesses of every size.
</p>
</motion.div>

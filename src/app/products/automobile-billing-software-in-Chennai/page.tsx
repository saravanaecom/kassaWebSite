...
const QUICK_FEATURES = [
  { label: "Fast & Smart Billing",           color: "#2563EB" },
  { label: "Customer-wise Sales Rate",       color: "#7C3AED" },
  { label: "Customer Due Bill Report",       color: "#059669" },
  { label: "Bill Hold & Resume",             color: "#D97706" },
  { label: "e-Invoice & e-Way Integration",  color: "#DC2626" },
  { label: "WhatsApp Integration",           color: "#16A34A" },
  { label: "Mobile Reports App",             color: "#0284C7" },
...
const TABS = [
  ...
  },
  {
    ...
    items: [
      ...
      "Purchase Product Box to PCS Conversion",
      "Purchase & Sales Entry Auto Save",
...
>
  Empowering Modern <span style={{ color: "#2563EB" }}>Automobile Businesses</span> with Smart Billing
</h1>
...
>
  Manage billing, spare parts inventory, purchases, customer records,
  service history, GST invoicing, supplier management, and business
  reports through one intelligent platform. <strong style={{ color: "#0F172A", fontWeight: 700 }}>
  Kassapos Automobile Billing Software
  </strong> is designed for automobile shops, dealerships, service centers,
  and auto parts retailers to streamline operations and improve business efficiency.
</p>
            ...
            >
              {!videoPlaying ? (
                <div className="relative cursor-pointer" style={{ aspectRatio: "16/9", background: "#000" }} onClick={() => setVideoPlaying(true)}>
                  ...
                  <img   src="/images/Automobile&SparesShops.webp"alt="Kassapos Supermarket POS Demo" style={{ width: "120%", height: "175%", objectFit: "cover", opacity: 0.82 }} />
...
>
  Simplify billing, spare parts inventory, purchase management,
  supplier tracking, service records, customer management,
  GST invoicing, analytics, and business reporting with one
  powerful solution built for modern automobile businesses.
</p>
</motion.div>

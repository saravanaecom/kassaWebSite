...
const TABS = [
  {
    ...
    color: "#2563EB",
    items: [
      "Online & Offline Billing System",
    "Web Based Online Billing System",
    "Application Based Office Billing System",
    "Product Creation & Barcode Label Printing in One Place",
    "Stock Transfer in One Place",
...
> 
  KASSAPOS Warehouse Management Billing Software helps <strong>businesses
  manage inventory, stock movement, billing, purchases, and warehouse
  operations </strong> through a centralized online and offline platform,
  ensuring accurate tracking, faster processing, and complete
...
>
  ...
  with Real-Time Inventory Intelligence
  </h2>
  ...
  >
    Manage inventory, stock movement, purchases, billing, and warehouse operations through a centralized platform with real-time visibility and complete control.
  </p>
</motion.div>

...
const QUICK_FEATURES = [
  { label: "Serial No. Wise Billing",          color: "#2563EB" },
  { label: "Serial Number Tracking",           color: "#7C3AED" },
  { label: "Product & Service Entry",          color: "#059669" },
...
export default function SupermarketPage() {
        ...
        <div className="container-xl" style={{ paddingLeft: 24, paddingRight: 24, position: "relative", zIndex: 1 }}>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 items-center" style={{ paddingBottom: 56 }}>
            ...
            >
              ...
              >
                Powering Smarter{" "}
                <span style={{ color: "#2563EB" }}>Home Appliance Retail</span> Software
              </h1>
  ...
  </strong>.are electrical machines which helps in household functions, such as cooking, cleaning or food preservation.    </p>
            ...
            >
              {!videoPlaying ? (
                <div className="relative cursor-pointer" style={{ aspectRatio: "16/9", background: "#000" }} onClick={() => setVideoPlaying(true)}>
                  ...
                  <img   src="/images/HomeAppliance.webp"alt="Kassapos Supermarket POS Demo" style={{ width: "120%", height: "150%", objectFit: "cover", opacity: 0.82 }} />

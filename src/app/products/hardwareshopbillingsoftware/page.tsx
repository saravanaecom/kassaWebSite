...
const QUICK_FEATURES = [
  { label: "Quick&Smart Billing",              color: "#2563EB" },
  { label: " SQFT Calculation Billing",         color: "#7C3AED" },
  { label: "Pcs & Kgs Billing",        color: "#059669" },
  { label: "Inventory Reorders",            color: "#D97706" },
...
const TABS = [
  {
    ...
    items: [
      "Quick & Smart Billing",
      "SQFT (Width × Height × Qty) Calculation Billing",
      "FEET (Height × Qty) Calculation Billing",
      "PCS, KG & LTR UOM Calculation Billing",
      "NOMS Conversion Calculation Billing",
      "Automatic Inventory Reorder Management",
      "Quotation, Delivery Challan & Sales Order",
      "Negative Stock Management",
      "Multiple Company Management",
      "Minimum Stock Alert on Billing Screen",
      "Customer Credit Limit Management",
      "Thermal, A4 Full & A4 Half Bill Printing",
    ],
  },
  {
    id: "purchase",
    ...
    items: [
      ...
      "Auto Save for Purchase & Sales Entry",
  ...
  },
  {
    ...
    color: "#059669",
    items: [
      "Purchase, Sales & Stock Reports",
      "Product-wise & Day-wise Profit Reports",
      "Customer & Supplier Statement Reports",
      "Ledger, Cash Book, Bank Book & Day Book",
      "GST Sales & Purchase Excel Export",
      "User-wise Access Rights & Cashier-wise Sales Reports",
      "Automatic Daily Database Backup",
      "Google Drive Auto Backup",
      "POP Alerts (Reorder Level, Expiry Date & Customer Due)",
      "Company-wise Profit & Loss Report",
    ],
  },
];
const WHY_CHOOSE = [
...
>
  Complete Billing Solution for <span style={{ color: "#2563EB" }}>Hardware Stores</span>
</h1>
...
>
  Manage billing, <strong style={{ color: "#0F172A", fontWeight: 700 }}>
    inventory, barcode sales, stock control, supplier management, GST invoicing, purchase tracking, and business reports
  </strong> through a single intelligent platform. Kassapos Hardware Shop Billing Software is built for stores selling fasteners, building materials, hand tools, power tools, plumbing supplies, electrical supplies, paints, garden products, locks, hinges, and other hardware products with speed and accuracy.
</p>
            ...
            >
              {!videoPlaying ? (
                <div className="relative cursor-pointer" style={{ aspectRatio: "16/9", background: "#000" }} onClick={() => setVideoPlaying(true)}>
                  ...
                  <img   src="/images/Hardware&PlywoodStores.webp"alt="Kassapos Supermarket POS Demo" style={{ width: "120%", height: "175%", objectFit: "cover", opacity: 0.82 }} />
...
<SectionLabel className="mx-auto mb-4">
  Hardware Store Management Suite
</SectionLabel>
...
>
  Simplify billing, inventory management, barcode scanning, purchase management,
  supplier records, stock monitoring, customer accounts, GST reporting, and
  business analytics with one powerful solution designed specifically for

...
const YOUTUBE_ID = "sE0I88d4WFc";

const QUICK_FEATURES = [
  { label: "Quick & Fast Billing",         color: "#2563EB" },
  { label: "Birthday Cake Orders",         color: "#7C3AED" },
  { label: "Raw Material Stock",           color: "#059669" },
        ...
        <div className="container-xl" style={{ paddingLeft: 24, paddingRight: 24, position: "relative", zIndex: 1 }}>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 items-center" style={{ paddingBottom: 56 }}>
            ...
            >
              ...
              >
                Super {" "}
                <span style={{ color: "#2563EB" }}>Billing & Management</span> Solution for Bakeries
                 
              </h1>

              <p style={{ color: "#64748B", marginBottom: 28, fontSize: "0.95rem", lineHeight: 1.75, maxWidth: 520 ,marginLeft: "0%"}}>
              Kassapos Bakery Billing Software is   <strong style={{ color: "#0F172A", fontWeight: 700 }}>
              designed specifically for bakeries, cake shops, pastry outlets, and confectionery businesses.
  </strong>Manage billing, inventory, recipes, production, sales, and customer orders from a single platform with ease.
              </p>
            ...
            >
              {!videoPlaying ? (
                <div className="relative cursor-pointer" style={{ aspectRatio: "16/9", background: "#000" }} onClick={() => setVideoPlaying(true)}>
                  ...
                  <img   src="/images/Bakery & Sweet Shop.webp"alt="Kassapos Supermarket POS Demo" style={{ width: "120%", height: "170%", objectFit: "cover", opacity: 0.82 }} />
...
>
  ...
  >
    Optimize daily operations, minimize stock wastage, track sales performance in real time, and deliver exceptional customer experiences while driving sustainable business growth.
  </p>
</motion.div>

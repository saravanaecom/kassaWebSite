...
const QUICK_FEATURES = [
  { label: "KOT Order Billing",         color: "#2563EB" },
  { label: "Mobile KOT Ordering",       color: "#7C3AED" },
  { label: "Table Management",          color: "#059669" },
  { label: "Food Costing",              color: "#D97706" },
  { label: "Online Order Integration",  color: "#DC2626" },
        ...
        <div className="container-xl" style={{ paddingLeft: 24, paddingRight: 24, position: "relative", zIndex: 1 }}>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 items-center" style={{ paddingBottom: 56 }}>
            ...
            >
              ...
              >
                Powering Modern Smart POS Software for{" "}
                <span style={{ color: "#2563EB" }}>Modern Bars & Pubs</span> 
                
              </h1>

              <p style={{ color: "#64748B", marginBottom: 28, fontSize: "0.95rem", lineHeight: 1.75, maxWidth: 520 ,marginLeft: "0%"}}>
              Take complete control of your bar operations with <strong style={{ color: "#0F172A", fontWeight: 700 }}>
              Kassapos Bar Billing Software
  </strong> powerful POS solution designed specifically for bars, pubs, lounges, and nightlife businesses. Manage billing, liquor inventory, stock movement, sales tracking, and GST invoicing from a single platform while improving service speed and maximizing profitability.
              </p>
            ...
            >
              {!videoPlaying ? (
                <div className="relative cursor-pointer" style={{ aspectRatio: "16/9", background: "#000" }} onClick={() => setVideoPlaying(true)}>
                  ...
                  <img   src="/images/Bar.webp"alt="Kassapos Supermarket POS Demo" style={{ width: "120%", height: "170%", objectFit: "cover", opacity: 0.82 }} />
...
>
Intelligent Bar Operations Platform Built for{" "}
...
<p
  className="text-base text-slate-500 max-w-1xl mx-auto"
  style={{ lineHeight: 1.7 }}
>
Simplify Billing. Control Inventory. Maximize Profits. All from one intelligent bar management system.
</p>

          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 items-center" style={{ paddingBottom: 56 }}>
            ...
            >
              ...
              >
                ...
                <span style={{ color: "#2563EB" }}>Food Courts</span>
                
              </h1>

              <p style={{ color: "#64748B", marginBottom: 28, fontSize: "0.95rem", lineHeight: 1.75, maxWidth: 520 ,marginLeft: "0%"}}>
              Kassapos Food Court Billing Software is built for modern   <strong style={{ color: "#0F172A", fontWeight: 700 }}>
              retail food environments that demand speed, accuracy, and scalability.

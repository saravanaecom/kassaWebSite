...
>
  <strong style={{ color: "#0F172A", fontWeight: 700 }}>
    Kassapos Juice Shop Billing Software
  </strong>{" "}
  is designed to simplify daily billing and business management for
  juice shops and beverage outlets. It features an easy-to-use accounting
  module that requires no finance knowledge, provides accurate balance
  sheets, supports barcode billing, inventory management, purchase
  entries, supplier payment tracking, GST invoicing, and real-time sales
  reports to help your business run smoothly.
</p>
            ...
            >
              {!videoPlaying ? (
                <div className="relative cursor-pointer" style={{ aspectRatio: "16/9", background: "#000" }} onClick={() => setVideoPlaying(true)}>
                  ...
                  <img   src="/images/Juice Shop.webp"alt="Kassapos Supermarket POS Demo" style={{ width: "120%", height: "170%", objectFit: "cover", opacity: 0.82 }} />
...
>
An all-in-one POS solution for juice shops and beverage businesses,
  simplifying billing, inventory, billing operations, GST invoicing,
  customer management, and business reporting in one powerful platform.
</p>
</motion.div>

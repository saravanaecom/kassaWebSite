...
const TABS = [
  {
    ...
    color: "#2563EB",
    items: [
      "Easy & Fast Mobile Shop Billing",
      "GST Invoice Generation",
      "Personalized Invoice Templates",
      "Estimate & Tax Invoice",
      "Barcode Billing & Scanner Support",
            ...
            >
              ...
              >
                <strong style={{ color: "#0F172A", fontWeight: 700 }}>
                  KASSAPOS Mobile Shop Billing Software
                </strong>{" "}
                helps you manage mobile sales, IMEI and serial number tracking, repair
                services, accessories billing, inventory, purchases, GST invoicing,
                customer accounts, warranty management, and real-time business reports—all
                from one secure, fast, and easy-to-use online and offline platform.
              </p>{/* Quick features — adapted to light bg */}

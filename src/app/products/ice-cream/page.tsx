...
const QUICK_FEATURES = [
  { label: "Self Service Billing",              color: "#2563EB" },
  { label: "KOT Mobile Order",         color: "#7C3AED" },
  { label: "Table Management",        color: "#059669" },
  { label: "KOT Management",            color: "#D97706" },
  { label: "OnlineOrder Integration",   color: "#DC2626" },
...
const TABS = [
  {
    ...
    color: "#2563EB",
    items: [
      "Easy & Fast Billing with Touch Screen POS",
      "KOT Orders via Mobile & Tablet",
      "User Friendly POS System | Works Offline & Online | Cloud Based",
      "English & Tamil Language Support",
      "Table Management | Merge | Split | Change",
      "Pending Tables | Pending Bills | Pending Settlements",
      "KOT Management",
      "Kitchen KOT Printing (USB | Network | Wi-Fi)",
      "Food Costing Management",
      "Dine-In | Takeaway | Home Delivery | Online Orders",
  ...
  },
  {
    ...
    "Reorder Level Raw Material Stock Management",
    "Indent, Issue, Return & Wastage Management",
    "Stock Inward & Stock Outward",
    "Kitchen Stock Issue Management",
    "Raw Material Stock Adjustment",
    "Production Planning & Production Entry",
  ...
  },
  {
    ...
    "POS Type Wise Item Wise Reports",
    "Steward & Waiter Commission Reports",
    "CRM Points & Loyalty Reports",
    "Raw Material Stock Reports",
        ...
        <div className="container-xl" style={{ paddingLeft: 24, paddingRight: 24, position: "relative", zIndex: 1 }}>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 items-center" style={{ paddingBottom: 56 }}>
            ...
            >
              ...
              >
                Transform Your{" "}
                <span style={{ color: "#2563EB" }}>Ice Cream Shop</span> with Intelligent POS Technology
              </h1>

              <p style={{ color: "#64748B", marginBottom: 28, fontSize: "0.95rem", lineHeight: 1.75, maxWidth: 520 ,marginLeft: "0%"}}>
              Running a successful ice cream shop requires fast billing, <strong style={{ color: "#0F172A", fontWeight: 700 }}>
              accurate inventory management, and excellent customer service.
  </strong> KASSAPOS Ice Cream Shop Billing Software is designed to streamline daily operations and help you deliver a smooth customer experience.
              </p>
            ...
            >
              {!videoPlaying ? (
                <div className="relative cursor-pointer" style={{ aspectRatio: "16/9", background: "#000" }} onClick={() => setVideoPlaying(true)}>
                  ...
                  <img   src="/images/Ice Cream Shop.webp"alt="Kassapos Supermarket POS Demo" style={{ width: "120%", height: "170%", objectFit: "cover", opacity: 0.82 }} />
...
>
  ...
  >
    ...
    </span>    for Faster Service & Smarter Growth
  </h2>
  ...
  >
    Streamline billing, inventory management, employee tracking,
    customer loyalty programs, sales analytics, GST compliance,
    and business reporting with one intelligent platform designed
    specifically for modern ice cream parlors and dessert outlets.
  </p>
</motion.div>

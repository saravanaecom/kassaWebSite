...
const QUICK_FEATURES = [
  ...
  { label: "Quick Billing",               color: "#059669" },
  { label: "Purchase Entry",              color: "#D97706" },
...
>
  Manage sales, GST billing, inventory, barcode scanning, customer relationships,
  purchasing, supplier management, and business reporting through one intelligent
  platform. <strong style={{ color: "#0F172A", fontWeight: 700 }}>
  Kassapos Retail Mobile Billing Software
  </strong> helps retail stores streamline daily operations, improve customer
  experience, and efficiently manage single or multiple store locations with
  real-time insights.
</p>
            ...
            >
              {!videoPlaying ? (
                <div className="relative cursor-pointer" style={{ aspectRatio: "16/9", background: "#000" }} onClick={() => setVideoPlaying(true)}>
                  ...
                  <img   src="/images/RetailShopMobileBilling.webp"alt="Kassapos Supermarket POS Demo" style={{ width: "120%", height: "170%", objectFit: "cover", opacity: 0.82 }} />
...
>
  Simplify billing, inventory management, barcode sales, purchasing,
  supplier management, customer loyalty, stock control, GST invoicing,
  analytics, and multi-store operations with one powerful retail solution

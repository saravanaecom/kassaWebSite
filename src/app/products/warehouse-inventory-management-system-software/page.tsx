...
const QUICK_FEATURES = [
  { label: "Real-Time Inventory Tracking",    color: "#2563EB" },
  { label: "Barcode Management",              color: "#7C3AED" },
  { label: "Warehouse Automation",            color: "#059669" },
  { label: "Order Management",                color: "#D97706" },
  { label: "RFID Integration",                color: "#DC2626" },
  { label: "MIS Reports",                     color: "#16A34A" },
  { label: "ERP Integration",                 color: "#0284C7" },
  { label: "GST Billing & Invoicing",         color: "#EA4335" },
];
...
const TABS = [
  {
    ...
    items: [
      ...
      "Incoming & Outgoing Inventory Management",
      "Multi-Channel Inventory Management",
      "Warehouse Layout & Workflow Management",
      "Product Delivery, Return & Storage Tracking",
      "Reduced Manual Work & Labor Cost",
      "Secure Inventory Data Management",
      "Affordable for Small & Large Businesses",
      "Automatic Data Storage & Management",
    ],
  },
  {
    id: "operations",
    label: "Operations & Order Management",
...
>
  ...
  />
 Warehouse Inventory Management System Software
</motion.div>
...
>
  <strong style={{ color: "#0F172A" }}>
    KASSAPOS Warehouse Management Software
  </strong>{" "}
  is designed to simplify warehouse operations by managing inventory, stock movement,
  purchases, sales, billing, and order processing from a single platform.
  Monitor inventory in real time, improve warehouse efficiency, reduce manual
  errors, and streamline your entire supply chain with a secure, scalable
            ...
            >
              {!videoPlaying ? (
                <div className="relative cursor-pointer" style={{ aspectRatio: "16/9", background: "#000" }} onClick={() => setVideoPlaying(true)}>
                  ...
                  <img   src="/images/WarehouseInventoryManagement.webp"alt="Kassapos Supermarket POS Demo" style={{ width: "120%", height: "175%", objectFit: "cover", opacity: 0.82 }} />
...
>
  <SectionLabel className="mx-auto mb-4">
    Warehouse  Inventory Management Billing Software
  </SectionLabel>
  ...
  >
    Manage inventory, stock movement, purchases, billing, and warehouse Inventory operations through a centralized platform with real-time visibility and complete control.
  </p>
</motion.div>

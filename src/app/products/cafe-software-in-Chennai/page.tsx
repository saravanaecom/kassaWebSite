        ...
        <div className="container-xl" style={{ paddingLeft: 24, paddingRight: 24, position: "relative", zIndex: 1 }}>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 items-center" style={{ paddingBottom: 56 }}>
            ...
            >
              ...
              >
                Next-Generation{" "}
                <span style={{ color: "#2563EB" }}>Cafe Management</span>
                
              </h1>

              <p style={{ color: "#64748B", marginBottom: 28, fontSize: "0.95rem", lineHeight: 1.75, maxWidth: 520 ,marginLeft: "0%"}}>
              Deliver   <strong style={{ color: "#0F172A", fontWeight: 700 }}>
              faster service and create memorable
  </strong> customer experiences with KassaPOS Cafe Billing Software. From billing and inventory management to takeaway orders, self-service, purchases, and real-time reports, our all-in-one solution helps cafés and coffee shops run smoothly and efficiently.
              </p>
            ...
            >
              {!videoPlaying ? (
                <div className="relative cursor-pointer" style={{ aspectRatio: "16/9", background: "#000" }} onClick={() => setVideoPlaying(true)}>
                  ...
                  <img   src="/images/Cafe.webp"alt="Kassapos Supermarket POS Demo" style={{ width: "120%", height: "170%", objectFit: "cover", opacity: 0.82 }} />
...
>
  ...
  Complete Cafe Management Suite
  </SectionLabel>

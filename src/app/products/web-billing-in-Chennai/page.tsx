...
const QUICK_FEATURES = [
  { label: "Online Billing System",          color: "#2563EB" },
  ...
  { label: "High-Speed AWS Server Hosting", color: "#DC2626" },
...
const TABS = [
  {
    ...
    items: [
      ...
      "User Friendly POS System & Cloud Based",
  ...
  },
  {
    ...
    items: [
      ...
      "Purchase Product Box to Nos. Conversion",
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 items-center" style={{ paddingBottom: 56 }}>
            ...
            >
              ...
              >
                ...
                <span style={{ color: "#2563EB" }}>Web-Based Billing Software</span>
                
              </h1>

              <p style={{ color: "#64748B", marginBottom: 28, fontSize: "0.95rem", lineHeight: 1.75, maxWidth: 520 ,marginLeft: "0%"}}>
              KASSAPOS Web Based Billing Software provides a secure and centralized platform to manage billing, inventory, sales, and customer operations from anywhere.<strong style={{ color: "#0F172A", fontWeight: 700 }}>
              Designed for supermarkets, grocery stores, pharmacies, department stores, and retail chains, it delivers real-time data access, seamless online connectivity, accurate inventory control, and powerful business
  </strong> insights for smarter decision-making and sustainable growth.
              </p>
            ...
            >
              {!videoPlaying ? (
                <div className="relative cursor-pointer" style={{ aspectRatio: "16/9", background: "#000" }} onClick={() => setVideoPlaying(true)}>
                  ...
                  <img   src="/images/Retail.webp"alt="Kassapos Supermarket POS Demo" style={{ width: "120%", height: "175%", objectFit: "cover", opacity: 0.82 }} />
...
>
  ...
  >
    Access billing, inventory, sales, and business reports anytime through a secure web-based platform with real-time synchronization and centralized management.
  </p>
</motion.div>

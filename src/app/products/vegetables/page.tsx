...
const TABS = [
  {
    ...
    color: "#2563EB",
    items: [
      "Easy & Fast Billing with Barcode Printing",
      "User Friendly POS System | Works Offline & Online | Cloud Based",
      "English & Tamil Language Support",
      "Weighing Scale Integration with Billing Screen",
      "Barcode Billing for Fruits & Vegetables",
  ...
  },
  {
    ...
    items: [
      ...
      "Fast Moving, Slow Moving & Non-Moving Product Reports",
      ...
      "Hourly Reports & Reprint Bill Summary",
    ],
  },
];
...
export default function SupermarketPage() {
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 items-center" style={{ paddingBottom: 56 }}>
            ...
            >
              ...
              >
                ...
                Vegetable & Fruits Billing Software
              </motion.div>
  ...
  for Fresh Produce Stores
</h1>

              <p style={{ color: "#64748B", marginBottom: 28, fontSize: "0.95rem", lineHeight: 1.75, maxWidth: 520 ,marginLeft: "0%"}}>
              Designed specifically for  <strong style={{ color: "#0F172A", fontWeight: 700 }}>
              vegetable shops, fruit markets, organic stores, and greengrocers,
  </strong> Kassapos helps you streamline billing, weighing scale integration, inventory tracking, and daily sales management. Deliver faster checkout experiences, reduce stock wastage, and manage your entire fresh produce business from one powerful platform.
              </p>
            ...
            >
              {!videoPlaying ? (
                <div className="relative cursor-pointer" style={{ aspectRatio: "16/9", background: "#000" }} onClick={() => setVideoPlaying(true)}>
                  ...
                  <img   src="/images/VegShop.webp"alt="Kassapos Supermarket POS Demo" style={{ width: "120%", height: "170%", objectFit: "cover", opacity: 0.82 }} />
...
>
  ...
  >
    Simplify weighing scale billing, inventory tracking, purchase management, stock control, customer management, sales analytics, and GST reporting with one powerful solution designed for modern fruit and vegetable retailers.
  </p>
</motion.div>

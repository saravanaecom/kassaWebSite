...
const YOUTUBE_ID = "iYmko-AnJYQ";

const QUICK_FEATURES = [
  { label: "Mobile & Tablet Billing",      color: "#2563EB" },
  { label: "Bluetooth & USB Printing",     color: "#7C3AED" },
  { label: "Self-Service Billing",         color: "#059669" },
  { label: "Table Service Billing",        color: "#D97706" },
  { label: "Offline Billing System",       color: "#DC2626" },
...
const TABS = [
  {
    ...
    "Cashier Wise Billing",
    "Bill Reprint Options",
  ...
  },
  {
    ...
    "Category Wise Item Reports",
    "Reprint Bill Summary Report",
...
>
  <strong style={{ color: "#0F172A", fontWeight: 700 }}>
    Kassapos Restaurant Mobile Billing Software
  </strong>{" "}
  transforms your smartphone or tablet into a powerful mobile POS system,
  enabling fast billing, order taking, and secure payment processing from
  anywhere in your restaurant or food court. Designed for restaurants, food
  courts, stall counters, cafés, and retail food businesses, it streamlines
  table service, kitchen communication, GST billing, inventory management,
  and real-time sales reporting—helping you serve customers faster and manage
            ...
            >
              {!videoPlaying ? (
                <div className="relative cursor-pointer" style={{ aspectRatio: "16/9", background: "#000" }} onClick={() => setVideoPlaying(true)}>
                  ...
                  <img   src="/images/RestaurantMobileBilingsoftware.webp"alt="Kassapos Supermarket POS Demo" style={{ width: "120%", height: "170%", objectFit: "cover", opacity: 0.82 }} />
...
>
  Simplify mobile billing, table and takeaway orders, food court vendor
  management, kitchen order tickets (KOT), inventory tracking, GST invoicing,
  digital payments, customer loyalty, sales analytics, and real-time business
  reporting with one powerful mobile POS solution built for modern restaurants

...
const QUICK_FEATURES = [
  { label: "TouchScreen Billing",              color: "#2563EB" },
  { label: "WeighingScale Integration",         color: "#7C3AED" },
  { label: " Muliple MRP Billing",        color: "#059669" },
  { label: "Whatsapp Integration",            color: "#D97706" },
  { label: "Free Offer Management",   color: "#DC2626" },
  { label: "Mobile Report App",         color: "#16A34A" },
  { label: " Bill Hold Options",            color: "#0284C7" },

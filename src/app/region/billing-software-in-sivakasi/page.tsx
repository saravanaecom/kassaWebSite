...
>
  ...
  <span style={{ color: "#2563EB" }}>Billing Software</span>{" "}
...
>
  ...
  <strong style={{ color: "#0F172A", fontWeight: 700 }}>
    KassaPOS, a powerful Billing Software in Sivakasi.
  </strong>{" "}
...
<section style={{ background: "#fff", padding: "72px 0" }}>
  <div className="container-xl" style={{ paddingLeft: 24, paddingRight: 24 }}>
    ...
    >
      <SectionLabel as="h2" className="mx-auto mb-4">
        Trusted Across Sivakasi
      </SectionLabel>
      <h2
        className="font-display font-bold text-slate-900 mb-4"
        style={{ fontSize: "clamp(1.75rem, 3.5vw, 2.6rem)", lineHeight: 1.15, letterSpacing: "-0.01em" }}
      >
        The Complete <span className="gradient-text">Billing Software</span> Sivakasi Businesses Rely On
      </h2>
      <p className="text-base text-slate-500 max-w-3xl mx-auto" style={{ lineHeight: 1.7 }}>
        Everything you need to know about how KassaPOS supports retail, GST compliance, cloud access and point-of-sale operations across Sivakasi.
      </p>
    </motion.div>
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
      ...
      >
        ...
        <p className="text-slate-600 text-sm" style={{ lineHeight: 1.75 }}>
          Manage products, customers, suppliers, discounts, loyalty programs and stock from one dashboard. Our Retail Billing Software in Sivakasi is ideal for supermarkets, grocery stores, pharmacies, textile shops and wholesale businesses.
        </p>
      </motion.div>
      ...
      >
        ...
        <p className="text-slate-600 text-sm" style={{ lineHeight: 1.75 }}>
          Generate GST-compliant invoices, manage HSN codes, tax reports and purchase registers with ease. Our GST Billing Software in Sivakasi keeps your business compliant while saving time.
        </p>
      </motion.div>
      ...
      >
        ...
        <p className="text-slate-600 text-sm" style={{ lineHeight: 1.75 }}>
          Access sales, inventory and reports from anywhere. Secure cloud backup, mobile dashboards and multi-branch synchronization make KassaPOS a dependable Cloud Billing Software in Sivakasi.
        </p>
      </motion.div>
    ...
    >
      <h2 className="font-bold text-slate-900 mb-3" style={{ fontSize: "1.15rem", letterSpacing: "-0.01em" }}>
        Why Businesses in Sivakasi Trust KassaPOS
      </h2>
      <p className="text-slate-600 text-sm" style={{ lineHeight: 1.75 }}>
        Local implementation, training, responsive support, affordable pricing and continuous software updates make KassaPOS a preferred solution across Sivakasi.
      </p>
    </motion.div>

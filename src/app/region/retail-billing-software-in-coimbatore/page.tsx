...
>
  Manage your retail business with reliable{" "}
  <strong style={{ color: "#0F172A", fontWeight: 700 }}>
    Retail Billing Software
  </strong>{" "}
  designed to make everyday store operations faster and easier. From quick
  billing and GST invoicing to inventory tracking, barcode management, and
  sales reporting, KassaPOS helps retailers stay organized and efficient.
  Reduce manual work, maintain accurate stock levels, and manage your store
  with confidence using a complete retail billing and management solution.
</p>

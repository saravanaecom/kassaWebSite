...
const QUICK_FEATURES = [
  { label: "Mobile Shop Billing",        color: "#2563EB" },
  { label: "Barcode Billing",            color: "#7C3AED" },
  { label: "GST Invoice Generation",     color: "#059669" },
  { label: "Inventory Management",       color: "#D97706" },
  { label: "Stock Management",           color: "#DC2626" },
  { label: "SMS & Email Integration",    color: "#16A34A" },
  { label: "Advanced Reports",           color: "#0284C7" },
  { label: "Online & Offline Billing",   color: "#EA4335" },
];
...
const TABS = [
  {
    ...
    color: "#2563EB",
    items: [
      "Fast Mobile & Accessories Billing",
      "IMEI Number Based Billing",
      "Serial Number Tracking",
      "GST Invoice for Mobile Sales",
      "Barcode Scanner for Handsets & Accessories",
      "Multiple MRP & Selling Price Management",
      "Mobile Exchange & Upgrade Billing",
      "Advance Payment & Balance Collection",
      "Cash, Card, UPI & Other Payment Modes",
      "Thermal & A4 Invoice Printing",
      "Bill Hold & Recall Options",
...

  {
    ...
    color: "#7C3AED",
    items: [
      "Mobile Handset Inventory Management",
      "Brand & Model-Wise Stock Tracking",
      "IMEI & Serial Number Stock Control",
      "Mobile Accessories Inventory",
      "Purchase & Supplier Management",
      "Mobile Stock Inward & Outward Tracking",
      "Sales Return & Product Exchange Management",
      "Repair & Service Entry Management",
      "Warranty Period Tracking",
      "Dead Stock & Slow Moving Stock Identification",
      "Low Stock Alerts for Handsets & Accessories",
      "Supplier Purchase & Payment Tracking",
    ],
  },

  {
    id: "reports",
    label: "Reports & Utilities",
    icon: <BarChart3 size={18} />,
    color: "#059669",
    items: [
      "IMEI-Wise Sales & Stock Report",
      "Mobile Brand & Model-Wise Sales Report",
      "Accessory Sales Performance Report",
      "Daily & Monthly Sales Analysis",
      "Purchase & Supplier Performance Reports",
      "Mobile Exchange Transaction Report",
      "Repair & Service Status Report",
      "Warranty Expiry Tracking Report",
      "Customer Purchase History Report",
      "Profit Analysis by Product & Brand",
      "Cashier-Wise Mobile Sales Report",
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 items-center" style={{ paddingBottom: 56 }}>
            ...
            >
              ...
              >
                ...
                />{" "}
                Mobile Shop Billing Software in Coimbatore
              </motion.div>
              ...
              >
                <strong style={{ color: "#0F172A", fontWeight: 700 }}> KASSAPOS Mobile Shop Billing Software in Coimbatore</strong>{" "} gives mobile retailers an efficient way to manage sales, IMEI and serial number tracking, accessories, repairs, purchases, inventory, GST invoices, customer accounts, and warranty details. Manage your complete mobile store from one reliable platform with faster billing, accurate stock control, organized customer records, and real-time business insights. </p>{/* Quick features — adapted to light bg */}
            ...
            >
              {!videoPlaying ? (
                <div className="relative cursor-pointer" style={{ aspectRatio: "16/9", background: "#000" }} onClick={() => setVideoPlaying(true)}>
                  ...
                  <img   src="/images/MobileBillingSoftware.webp"alt="Kassapos Supermarket POS Demo" style={{ width: "120%", height: "175%", objectFit: "cover", opacity: 0.82 }} />
...
<p
  className="text-base text-slate-500 max-w-9xl mx-auto"
  style={{ lineHeight: 1.7 }}
>
  <strong className="text-slate-700">
    Power Your Mobile Retail Business
  </strong>{" "}
  with a complete solution for faster billing, IMEI and serial number
  tracking, mobile sales, repair management, accessories billing, GST
  invoicing, inventory management, and customer records. KassaPOS helps
  mobile shops streamline everyday operations, keep stock accurate, track
  device details effortlessly, and gain clear insights into sales and
  business performance from one powerful platform.
</p>
</motion.div>

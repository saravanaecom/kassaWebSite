          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 items-center" style={{ paddingBottom: 56 }}>
            ...
            >
              ...
              >
                ...
                />{" "}
                Mobile Shop Billing Software in Trichy
              </motion.div>
              ...
              >
                <strong style={{ color: "#0F172A", fontWeight: 700 }}> KASSAPOS Mobile Shop Billing Software in Trichy</strong>{" "} gives mobile retailers an efficient way to manage sales, IMEI and serial number tracking, accessories, repairs, purchases, inventory, GST invoices, customer accounts, and warranty details. Manage your complete mobile store from one reliable platform with faster billing, accurate stock control, organized customer records, and real-time business insights. </p>{/* Quick features — adapted to light bg */}
...
>
  ...
  Take control of your mobile retail business with streamlined billing,
  device and IMEI management, service and repair tracking, GST invoicing,
  stock monitoring, accessories sales, customer records, and performance
  reports. KassaPOS connects your essential store operations in one place,
  helping you reduce manual tasks, improve billing accuracy, and make smarter

          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 items-center" style={{ paddingBottom: 56 }}>
            ...
            >
              ...
              >
                ...
                />{" "}
                Mobile Shop Billing Software in Sivakasi
              </motion.div>
              ...
              >
                <strong style={{ color: "#0F172A", fontWeight: 700 }}> KASSAPOS Mobile Shop Billing Software in Sivakasi</strong>{" "} gives mobile retailers an efficient way to manage sales, IMEI and serial number tracking, accessories, repairs, purchases, inventory, GST invoices, customer accounts, and warranty details. Manage your complete mobile store from one reliable platform with faster billing, accurate stock control, organized customer records, and real-time business insights. </p>{/* Quick features — adapted to light bg */}
...
>
  ...
  Simplify mobile sales, IMEI tracking, repair management, GST billing, inventory control, accessories billing, customer management, and business reporting with one intelligent platform designed for mobile retailers of every size. 
</p>
</motion.div>

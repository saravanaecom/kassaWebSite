          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 items-center" style={{ paddingBottom: 56 }}>
            ...
            >
              ...
              >
                ...
                />{" "}
                Mobile Shop Billing Software in Madurai
              </motion.div>
              ...
              >
                <strong style={{ color: "#0F172A", fontWeight: 700 }}> KASSAPOS Mobile Shop Billing Software in Madurai</strong>{" "} gives mobile retailers an efficient way to manage sales, IMEI and serial number tracking, accessories, repairs, purchases, inventory, GST invoices, customer accounts, and warranty details. Manage your complete mobile store from one reliable platform with faster billing, accurate stock control, organized customer records, and real-time business insights. </p>{/* Quick features — adapted to light bg */}
...
>
  ...
  Manage your mobile store with ease using smart tools for device sales,
  IMEI and serial number tracking, GST invoicing, stock management, repair
  services, accessories sales, customer records, and detailed business
  reports. KassaPOS brings essential mobile retail operations together in
  one powerful platform, helping you save time, improve accuracy, and manage

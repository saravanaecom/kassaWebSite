...
const QUICK_FEATURES = [
  { label: "Offline & Online Billing",        color: "#2563EB" },
  { label: "Multi Branch Management",        color: "#7C3AED" },
  { label: "Stock Transfer Between Branches", color: "#059669" },
  { label: "Dashboard & Weekly Sales",       color: "#D97706" },
  { label: "High-Speed AWS Server",          color: "#DC2626" },
...
const TABS = [
  {
    ...
    color: "#2563EB",
    items: [
      "Quick Counter Billing for High Customer Volume",
      "Barcode Scanner & Keyboard Billing Support",
      "GST-Compliant Invoice Generation",
      "Product Search by Code, Name & Barcode",
      "Estimate to Invoice Conversion",
      "Discount & Price Override Controls",
      "Product Category & Brand Management",
      "Batch-Wise Product Billing",
      "Expiry & Manufacturing Date Tracking",
      "Customer Search & Quick Selection",
      "Multiple Payment Mode Support",
      "Bill Hold, Recall & Resume Options",
  ...
  },
  {
    ...
    items: [
      ...
      "Purchase Invoice Verification & Entry",
      "Purchase Return Processing",
      "Opening Stock Entry Management",
      "Product Cost & Selling Price Management",
      "Batch-Wise Stock Tracking",
      "Stock Expiry Monitoring",
      "Inter-Branch Stock Movement",
      "Stock Shortage & Excess Identification",
  ...
  },
  {
    ...
    items: [
      ...
      "Sales Return & Purchase Return Reports",
      "Payment Mode Wise Sales Summary",
      "Tax Summary & GST Analysis",
      ...
      "Automated Data Security & Recovery",
    ],
  },
];
...
>
  ...
  />
  Cloud-Based Billing Solutions in Coimbatore
</motion.h1>
...
>
  Smarter{" "}
  <span style={{ color: "#2563EB" }}>Cloud POS Solutions</span> for
...
>
  Manage your entire retail operation with{" "}
  <strong style={{ color: "#0F172A", fontWeight: 700 }}>
    KASSAPOS Cloud Billing Software in Coimbatore.
  </strong>{" "}
  From billing and inventory to sales tracking and customer management,
  everything is connected through one reliable cloud-based platform. Access
  your business information whenever you need it, monitor daily performance
  in real time, and keep your operations running smoothly with seamless
  online and offline billing capabilities.
</p>
            ...
            >
              {!videoPlaying ? (
                <div className="relative cursor-pointer" style={{ aspectRatio: "16/9", background: "#000" }} onClick={() => setVideoPlaying(true)}>
                  ...
                  <img   src="/images/CouldOfflineandOnlineBilling.webp"alt="Kassapos Supermarket POS Demo" style={{ width: "120%", height: "164%", objectFit: "cover", opacity: 0.82 }} />
...
>
  ...
  >
    Centralize billing, inventory, sales, and business analytics with a secure cloud platform that delivers real-time insights, seamless synchronization, and complete operational control from anywhere.
  </p>
</motion.div>

...
const QUICK_FEATURES = [
  { label: "Fast & Easy Billing",        color: "#2563EB" },
  { label: "Barcode Scanner Support",    color: "#7C3AED" },
  { label: "Multiple Price Management",  color: "#059669" },
  { label: "WhatsApp Invoice Sharing",   color: "#D97706" },
  { label: "Smart Discount Management",  color: "#DC2626" },
  { label: "Real-Time Business Reports", color: "#16A34A" },
  { label: "Invoice Hold & Recall",      color: "#0284C7" },
  { label: "Automatic Cloud Backup",     color: "#EA4335" },
];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 items-center" style={{ paddingBottom: 56 }}>
            ...
            >
              ...
              >
                ...
                Retail Shop Billing Software in Sivakasi
              </motion.h1>
              ...
              >
                ...
                <span style={{ color: "#2563EB" }}>Speed And Confidence </span> Software
                 
              </h1>

              <p style={{ color: "#64748B", marginBottom: 28, fontSize: "0.95rem", lineHeight: 1.75, maxWidth: 520 ,marginLeft: "0%"}}>
              We are the best  <strong style={{ color: "#0F172A", fontWeight: 700 }}>
              Retail Billing Software in Chennai and Cloud Billing Software Solutions in Chennai.
  </strong>Our Retail Management deals with selling of goods and services to consumers. It involves a direct interaction with the customer and coordinates business activities from designing of a product to its delivery and post-delivery service.
              </p> */}
...
designed to simplify everyday retail operations and improve billing
efficiency. From fast GST billing and barcode scanning to inventory
tracking, sales management, and customer management, KassaPOS helps
retailers handle their daily business with ease. Reduce manual work,
maintain accurate stock records, and streamline your store operations with
a complete retail billing solution built for modern businesses in Sivakasi.
</p>
            ...
            >
              {!videoPlaying ? (
                <div className="relative cursor-pointer" style={{ aspectRatio: "16/9", background: "#000" }} onClick={() => setVideoPlaying(true)}>
                  ...
                  <img   src="/images/Retail.webp"alt="Kassapos Supermarket POS Demo" style={{ width: "120%", height: "170%", objectFit: "cover", opacity: 0.82 }} />

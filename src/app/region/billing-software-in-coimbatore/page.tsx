...
const TABS = [
  {
    ...
    color: "#2563EB",
    items: [
      "Fast POS Billing for Busy Retail Stores",
      "GST Invoice Generation with Accurate Tax Calculation",
      "Barcode Scanning for Quick Product Billing",
      "Online & Offline Billing Support",
      "Web-Based Billing System for Multi-Device Access",
      "Thermal, A4 Full & A4 Half Invoice Printing",
      "Product Creation with Integrated Barcode Label Printing",
      "Estimate & Quotation Billing",
      "Product Batch, Expiry & Manufacturing Date Management",
      "Free Offer, Discount & Scheme Management",
      "Customer Credit Limit & Outstanding Management",
      "Negative Stock Control",
      "Customer Loyalty Points & CRM Management",
      "Minimum Stock Alerts During Billing",
  ...
  },
  {
    ...
    color: "#7C3AED",
    items: [
      "Daily Sales, Purchase & Stock Reports",
      "Product-Wise Sales & Profit Analysis",
      "Day-Wise, Month-Wise & Period-Wise Profit Reports",
      "Customer & Supplier Statement Reports",
      "Ledger, Cash Book, Bank Book & Day Book",
      "GST Sales & Purchase Reports with Excel Export",
      "User-Wise Sales & Cashier Performance Reports",
      "Business-Wise & Branch-Wise Performance Reports",
      "Daily Automatic Database Backup",
      "Google Drive Backup & Data Protection",
      "Low Stock & Reorder Level Alerts",
      "Product Expiry & Batch Alerts",
      "Customer Outstanding & Payment Due Alerts",
      "Company-Wise Profit & Loss Reports",
      "Real-Time Business Dashboard & Performance Insights",
    ],
  },
  {
    id: "report",
...
>
  Smart, Simple, and Reliable Billing Solutions for{" "}
  <span style={{ color: "#2563EB" }}>Growing Businesses</span>
</h1>
...
>
Power your retail business with{" "}
<strong style={{ color: "#0F172A", fontWeight: 700 }}>
  KassaPOS, a reliable Billing Software in Coimbatore.
</strong>{" "}
Designed for modern retailers, KassaPOS simplifies GST invoicing, inventory
tracking, barcode billing, stock management, cloud synchronization, and POS
operations from one easy-to-use platform. From supermarkets and pharmacies
to textile stores, bakeries, restaurants, and electronics shops, KassaPOS
helps you manage sales efficiently, maintain accurate stock records, and
make faster business decisions with real-time reports. Choose a smarter way
to manage your store with{" "}
<strong style={{ color: "#0F172A", fontWeight: 700 }}>
...
<section style={{ background: "#fff", padding: "72px 0" }}>
  <div className="container-xl" style={{ paddingLeft: 24, paddingRight: 24 }}>
    ...
    >
      <SectionLabel as="h2" className="mx-auto mb-4">
        Trusted Across Coimbatore
      </SectionLabel>
      <h2
        className="font-display font-bold text-slate-900 mb-4"
        style={{ fontSize: "clamp(1.75rem, 3.5vw, 2.6rem)", lineHeight: 1.15, letterSpacing: "-0.01em" }}
      >
        The Complete <span className="gradient-text">Billing Software</span> Coimbatore Businesses Rely On
      </h2>
      <p className="text-base text-slate-500 max-w-3xl mx-auto" style={{ lineHeight: 1.7 }}>
        Everything you need to know about how KassaPOS supports retail, GST compliance, cloud access and point-of-sale operations across Coimbatore.
      </p>
    </motion.div>
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
      ...
      >
        ...
        <p className="text-slate-600 text-sm" style={{ lineHeight: 1.75 }}>
          Manage products, customers, suppliers, discounts, loyalty programs and stock from one dashboard. Our Retail Billing Software in Coimbatore is ideal for supermarkets, grocery stores, pharmacies, textile shops and wholesale businesses.
        </p>
      </motion.div>
      ...
      >
        ...
        <p className="text-slate-600 text-sm" style={{ lineHeight: 1.75 }}>
          Generate GST-compliant invoices, manage HSN codes, tax reports and purchase registers with ease. Our GST Billing Software in Coimbatore keeps your business compliant while saving time.
        </p>
      </motion.div>
      ...
      >
        ...
        <p className="text-slate-600 text-sm" style={{ lineHeight: 1.75 }}>
          Access sales, inventory and reports from anywhere. Secure cloud backup, mobile dashboards and multi-branch synchronization make KassaPOS a dependable Cloud Billing Software in Coimbatore.
        </p>
      </motion.div>
    ...
    >
      <h2 className="font-bold text-slate-900 mb-3" style={{ fontSize: "1.15rem", letterSpacing: "-0.01em" }}>
        Why Businesses in Coimbatore Trust KassaPOS
      </h2>
      <p className="text-slate-600 text-sm" style={{ lineHeight: 1.75 }}>
        Local implementation, training, responsive support, affordable pricing and continuous software updates make KassaPOS a preferred solution across Coimbatore.
      </p>
    </motion.div>

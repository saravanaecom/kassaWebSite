          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 items-center" style={{ paddingBottom: 56 }}>
            ...
            >
              ...
              >
                ...
                Retail Shop Billing Software in Coimbatore
              </motion.h1>
...
>
  ...
  <strong style={{ color: "#0F172A", fontWeight: 700 }}>
    Retail Billing Software in Trichy and Cloud Billing Software Solutions in Coimbatore
  </strong>
  {" "}designed to simplify everyday retail operations. From fast and accurate billing
  to inventory tracking and customer management, our solutions help businesses manage
  their sales efficiently. Streamline your store operations, reduce manual work, and
  deliver a smoother shopping experience with a powerful retail management system.
</p>
